using AppRunMyProcess.DataLogic;
...
namespace AppRunMyProcess.BusinessLogic
{
    public class BusinessLogic
    {
        //This class contains functions that are used to prepare the information to be inserted into the database.
