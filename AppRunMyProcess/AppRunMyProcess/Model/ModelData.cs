...
namespace AppRunMyProcess.Model
{
    class ModelData
    {
        //This class contains the model data of Run My Process database. This class is called by  orther classes to create objects whith this class.
